...
import os
os.environ["WANDB_DISABLED"] = "true"  # hard disable, even if installed
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_local_dir", type=str, default=None, help="Path to a datasets.save_to_disk() folder for offline loading.")
    ...
    training_args = TrainingArguments(
		...
		save_strategy="epoch" if args.save_epochs else "steps",
    )
